...
public class POCollectedGroup extends PhysicalOperator {
    ...
    protected DataBag outputBag = null;

    protected Object prevKey = null;

    protected transient boolean useDefaultBag;
    ...
    public POCollectedGroup(POCollectedGroup copy) {
        super(copy);
        this.plans = copy.plans;
        this.leafOps = copy.leafOps;
        this.keyType = copy.keyType;
        this.output = copy.output;
        this.outputBag = copy.outputBag;
        this.prevKey = copy.prevKey;
        this.useDefaultBag = copy.useDefaultBag;
    }
